...
(function(){
  const RULES = [
    ...
    },
    {
      ...
      product_type:'착용형 상품',
      // v21.8.24.107: 래쉬가드(물놀이) 전용이던 폴백 카피를 의류 일반 카피로 교체 — 다른 옷에 물놀이 문구가 새던 문제 수정.
      target_customer:'핏·소재·사이즈·코디 활용을 보고 옷을 고르는 사용자',
      main_pain_point:'실제 핏과 색감이 화면과 다를까, 사이즈 선택에 실패할까 걱정됨',
      core_value:'핏/실루엣, 소재감, 사이즈 정보, 실착 장면, 코디 활용',
    ...
    },
    {
      ...
      // v21.8.24.107: 명함지갑 전용이던 폴백 카피를 잡화 일반 카피로 교체 — 가방/모자/시계 등에 명함 문구가 새던 문제 수정.
      target_customer:'디자인·수납·휴대성이 생활 장면에 맞는지 보고 가방·지갑·잡화를 고르는 사용자',
      main_pain_point:'실물 질감과 크기, 수납력이 사진과 다를까, 매일 쓰기 불편하지 않을까 걱정됨',
      core_value:'소재·디테일, 수납 구성, 꺼내고 넣는 동선, 일상 휴대 장면, 선물 적합성',
      spec_hint:'소재, 크기, 수납 칸, 색상 옵션, 제조국, 구성품 확인 필요',
      competitor_hint:'비슷한 잡화는 실제 수납 장면과 꺼내 쓰는 순간의 설명이 부족할 수 있음',
